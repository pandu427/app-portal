        ...
        <>
          <Header aria-label="IBM Platform Name">
            ...
            <HeaderName href="#" prefix="">
              ESTUATE EMPLOYEE MANANEMENT SYSTEM
            </HeaderName>
            ...
            <SideNav aria-label="Side navigation" expanded={isSideNavExpanded}>
              ...
              <SideNavItems>
                <SideNavMenu title="TimeSheets">
                  <SideNavMenuItem href="">Daily Entry</SideNavMenuItem>
                  <SideNavMenuItem href="">weekly Entry</SideNavMenuItem>
                  <SideNavMenuItem href="">Link</SideNavMenuItem>
                </SideNavMenu>
                <SideNavMenu title="Recuritment">
                  <SideNavMenuItem href="">Link</SideNavMenuItem>
                  <SideNavMenuItem
                    // aria-current="page"
                    href="">
            ...
            <HeaderGlobalBar>
              <HeaderGlobalAction aria-label="Inc" onClick={() => {}}>
          ...
          <Switch>
            ...
            <Route exact path="/demo" component={Skeleton1} />
          </Switch>
        </>
      )}
    />
